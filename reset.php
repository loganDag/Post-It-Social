...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			To reset your password, visit the following address: <a href='".DIR."resetPassword.php?key=$token'>".DIR."resetPassword.php?key=$token";
...
?>
<title> Post it | Reset Password</title>
<div class="container">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<div class="form-group">
					<input type="email" name="email" id="email" class="form-control input-lg" placeholder="Please contact support to change password" value="" tabindex="1" disabled>
				</div>

				<hr>
				<div class="row">
					<div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Sent Reset Link" class="btn btn-primary btn-block btn-lg" tabindex="2" disabled></div>
				</div>
			</form>
		</div>
	</div>
